...
<o:PixelsPerInch>96</o:PixelsPerInch>
    ...
    <body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #F0F5F7">

        <!--[if IE]><div class="ie-browser"><![endif]-->
        <!--[if mso]><div class="mso-container"><![endif]-->
        <div class="nl-container" style="min-width: 320px;Margin: 0 auto;background-color: #F0F5F7">
            <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #F0F5F7;"><![endif]-->
                        ...
                        <div class="col num12" style="min-width: 320px;max-width: 600px;width: 600px;width: calc(28000% - 167400px);background-color: transparent;">
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div align="center" class="img-container center fullwidth" style="padding-right: 0px;  padding-left: 0px;">
                                    ...
                                    <div style="line-height:25px;font-size:1px">&#160;</div>  <img class="center fullwidth" align="center" border="0" src="http://www.enigmata.co.cr/img/rounder-up.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px" width="600">
                    ...
                    <div class="col num12" style="min-width: 320px;max-width: 600px;width: 600px;width: calc(28000% - 167400px);background-color: #FFFFFF;">
                        <div style="background-color: transparent; width: 100% !important;">
                            ...
                            <div align="center" class="img-container center" style="padding-right: 0px;  padding-left: 0px;">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                                <img class="center" align="center" border="0" src="http://www.enigmata.co.cr/img/logo.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 323px" width="323">
                                <!--[if mso]></td></tr></table><![endif]-->
                            </div>
                            ...
                            <div style="color:#555555;line-height:150%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Sala de Juegos de Escape. Heredia, Costa Rica</p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <div class="col num12" style="min-width: 320px;max-width: 600px;width: 600px;width: calc(28000% - 167400px);background-color: #FFFFFF;">
                        <div style="background-color: transparent; width: 100% !important;">
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#555555; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">¡Hola!</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Hemos recibido los datos para reservar una sesión de juego en Enigmata.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Si usted no hizo esta reservación puede ignorar este mensaje.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Los datos recibidos son:</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>Fecha</strong>: <?=$readable["date"]; ?></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>Hora</strong>:<?=$readable["hour"]; ?></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>Cuarto</strong>: <?=$readable["room"]; ?></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>Número de jugadores</strong>: <?=$res->people; ?><br></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>A nombre de</strong>: <?=$res->name; ?></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><strong>Teléfono</strong>: <?=$res->phone; ?></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Le recordamos que aun debe cancelar el costo de cada jugador.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Le solicitamos que se presente 15 minutos antes de la hora indicada.</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Si tiene dudas puede contactarnos al +506 8842 0134</p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">&#160;<br></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Gracias por usar nuestros servicios.</p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div align="center" class="button-container center" style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://www.enigmata.co.cr/rsvp/confirm/<?=$res->id; ?>?code=<?=$res->randomcode; ?>/" style="height:62px; v-text-anchor:middle; width:236px;" arcsize="7%" strokecolor="#325678" fillcolor="#325678"><w:anchorlock/><center style="color:#ffffff; font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size:16px;"><![endif]-->
                                <a href="http://www.enigmata.co.cr/rsvp/confirm/<?=$res->id; ?>?code=<?=$res->randomcode; ?>" target="_blank" style="display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #325678; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 216px; width: 186px; width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;mso-border-alt: none">
                                    <span style="font-size:16px;line-height:32px;">Confirmar Reservación</span>
                                </a>
                            ...
                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;"><![endif]-->
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#0D0D0D; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><span style="font-size: 11px; line-height: 16px;">Si el link anterior no funciona, copie y pegue la siguiente dirección en su navegador;</span><br></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center"><span style="font-size: 11px; line-height: 16px;">http://www.enigmata.co.cr/rsvp/confirm/<?=$res->id; ?>?code=<?=$res->randomcode; ?></span></p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
            ...
            <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;width: 600px;width: calc(29000% - 179200px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #525252;" class="block-grid three-up">
                <div style="border-collapse: collapse;display: table;width: 100%;">
                    ...
                    <div class="col num4" style="Float: left;max-width: 320px;min-width: 200px;width: 200px;width: calc(72200px - 12000%);background-color: #525252;">
                        <div style="background-color: transparent; width: 100% !important;">
                            ...
                            <div align="center" style="padding-right: 0px; padding-left: 0px; padding-bottom: 0px;">
                                ...
                                <div style="display: table; max-width:94;">
                                    <!--[if (mso)|(IE)]><table width="94" cellpadding="0" cellspacing="0" border="0"><tr><td style="border-collapse:collapse; padding-right: 0px; padding-left: 0px; padding-bottom: 0px;"  align="center"><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse; mso-table-lspace: 0pt;mso-table-rspace: 0pt; width:94px;"><tr><td width="32" style="width:32px; padding-right: 5px;" valign="top"><![endif]-->
                                    <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;Margin-right: 5px">
                                        <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                            <a href="https://www.facebook.com/enigmatacr/" title="Facebook" target="_blank">
                                                <img src="http://www.enigmata.co.cr/img/facebook@2x.png" alt="Facebook" title="Facebook" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                            </a>
                                    ...
                                    <table align="left" border="0" cellspacing="0" cellpadding="0" width="32" height="32" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;Margin-right: 0">
                                        <tbody><tr style="vertical-align: top"><td align="left" valign="middle" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                            <a href="https://instagram.com/enigmatacr" title="Instagram" target="_blank">
                                                <img src="http://www.enigmata.co.cr/img/instagram@2x.png" alt="Instagram" title="Instagram" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                            </a>
                                            <div style="line-height:5px;font-size:1px">&#160;</div>
                                            </td></tr>
                                        </tbody></table>
                    ...
                    <div class="col num4" style="Float: left;max-width: 320px;min-width: 200px;width: 200px;width: calc(72200px - 12000%);background-color: #525252;">
                        <div style="background-color: transparent; width: 100% !important;">
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%;color:#11D3B7; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;">
                                <div style="font-size:12px;line-height:14px;color:#11D3B7;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="color: rgb(255, 255, 255); font-size: 12px; line-height: 14px;"><span style="font-size: 12px; line-height: 14px; color: rgb(168, 191, 111);"><span style="color: rgb(0, 204, 255); font-size: 12px; line-height: 14px;">Tel</span>.:</span> +506 8842 0134</span><br></p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <div class="col num4" style="Float: left;max-width: 320px;min-width: 200px;width: 200px;width: calc(72200px - 12000%);background-color: #525252;">
                        <div style="background-color: transparent; width: 100% !important;">
                            ...
                            <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;"><![endif]-->
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:120%;color:#FFFFFF; padding-right: 0px; padding-left: 0px; padding-top: 20px; padding-bottom: 0px;">
                                <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="color: rgb(0, 204, 255); font-size: 12px; line-height: 14px;">Email</span>&#160;<span style="color: rgb(255, 255, 255); font-size: 12px; line-height: 14px;">gerencia@enigmata.co.cr</span></p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                ...
                <div style="border-collapse: collapse;display: table;width: 100%;">
                    ...
                    <div class="col num12" style="min-width: 320px;max-width: 600px;width: 600px;width: calc(28000% - 167400px);background-color: transparent;">
                        <div style="background-color: transparent; width: 100% !important;">
                            ...
                            <div align="center" class="img-container center fullwidth" style="padding-right: 0px;  padding-left: 0px;">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                                <img class="center fullwidth" align="center" border="0" src="http://www.enigmata.co.cr/img/rounder-dwn.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px" width="600">
                                <!--[if mso]></td></tr></table><![endif]-->
                            </div>
